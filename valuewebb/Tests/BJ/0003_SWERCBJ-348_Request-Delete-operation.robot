*** Settings ***
Documentation    Test Case 003 SWERCBJ-348. This Test Case is used to delete created transaction
...
*** Test Cases ***
Test Case 003 SWERCBJ-452 Request Delete operation
    [Tags]    Smoke
...
In Search TT Request page, select Stored option in Status dropdown then click Search button
    SearchTT_Requests_Page.Select Status of Transaction    ${TC003_STATUS}
