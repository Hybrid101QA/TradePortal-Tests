*** Settings ***
Documentation    Test Case 002 SWVW-1018. This Test Case is used to download .xml file
...
*** Variables ***
${TC002_XML_DOWNLOAD}   TT*.xml
${TC002_DOWNLOADS_DIRECTORY}    ${EXECDIR}/Results
${TC002_TT_STATUS}      FCVR Issued

*** Test Cases ***
Test Case 002 SWVW-1018 Verify Export XML operation
    [Tags]    Smoke
...
Search for the transaction based on the criteria by clicking the Eye button
    SearchTT_Requests_Page.Select Status of Transaction   ${TC002_TT_STATUS}
...
User should successfully downloaded the .xml file
    ...
    TT_Document_Page.Wait File Download to Finish   ${TC002_XML_DOWNLOAD}   ${TC002_DOWNLOADS_DIRECTORY}
    TT_Document_Page.File Should Exists in Downloads Directory  ${TC002_XML_DOWNLOAD}   ${TC002_DOWNLOADS_DIRECTORY}